...
const DCRUniverse: React.FC = () => {
  ...
  const contentConfig: Record<UniverseTab, TabContent> = {
    COLLECTION: {
      ...
      title: "PREMIUM \nCOLLECTION",
      description: "Descubre nuestra curadurÃ­a de vehÃ­culos de colecciÃ³n. Desde superdeportivos europeos hasta muscle cars americanos, cada vehÃ­culo es seleccionado por su exclusividad, historia y potencial de inversiÃ³n.",
      cta: "Explorar ColecciÃ³n Completa",
      href: "#/collection",
      specs: [
        { label: 'CategorÃ­a', value: 'ExÃ³ticos & ClÃ¡sicos', icon: Car },
        { label: 'Calidad', value: 'CertificaciÃ³n Premium', icon: Trophy },
      ]
    },
    SALES: {
      subtitle: "Acquisition & Brokerage",
      title: "EXCLUSIVE \nSALES",
      description: "Adquire el vehÃ­culo de tus sueÃ±os a travÃ©s de nuestra red global. Compra directa, subastas privadas y servicio de corretaje especializado en autos de colecciÃ³n con verificaciÃ³n completa.",
      cta: "Ver VehÃ­culos Disponibles",
      href: "#/sales",
      ...
      specs: [
        ...
        { label: 'Transparencia', value: 'InspecciÃ³n Completa', icon: Shield },
      ]
    },
    STORAGE: {
      subtitle: "Professional Asset Custody",
      title: "TECHNICAL \nSTORAGE",
      description: "Custodia de grado inversiÃ³n en Santiago. Protocolos aeroespaciales de mantenimiento, control climÃ¡tico de precisiÃ³n y seguridad biomÃ©trica avanzada para proteger tu inversiÃ³n.",
      cta: "Solicitar Custodia",
      href: "#/storage",
      image: "https://images.unsplash.com/photo-1502744691472-dc077b10058e?auto=format&fit=crop&q=80&w=1200",
      specs: [
        { label: 'Clima', value: 'Control de PrecisiÃ³n', icon: Trophy },
        { label: 'Seguridad', value: 'BiomÃ©trica 24/7', icon: Warehouse },
      ]
    }
  };
              ...
              <div className="w-full max-w-[540px] space-y-4 max-h-[700px] overflow-y-auto pr-2">
                {isLoadingVehicles ? (
                  ...
                  <div className="text-center py-20">
                    <p className="text-red-500">Error al cargar vehÃ­culos</p>
                  </div>
                  ...
                  <div className="text-center py-20">
                    ...
                    <p className="text-slate-500">No hay vehÃ­culos disponibles en este momento</p>
                  </div>
                )}
              </div>
            ) : (
