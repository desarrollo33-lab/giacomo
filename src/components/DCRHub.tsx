                      ...
                      >
                        ...
                        <div className="relative overflow-hidden" style={aspectStyle}>
                          ...
                          <div className="absolute top-3 right-3 z-20">
                            <div className="px-2 py-1 flex items-center gap-1.5" style={{ backgroundColor: '#181f25' }}>
                              {post.platform === 'tiktok' ? (
                                <Video className="w-3 h-3" style={{ color: '#ffffff' }} />
                              ) : (
                                <Youtube className="w-3 h-3" style={{ color: '#ffffff' }} />
                              )}
                          ...
                          <div className="absolute inset-0 flex items-center justify-center z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            <div className="w-16 h-16 flex items-center justify-center rounded-full" style={{ backgroundColor: 'rgba(24, 31, 37, 0.8)' }}>
